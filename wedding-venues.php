<?php 
$pageTitle = 'Destination Wedding Venues in Meerut City, Wedding Lawns Halls, India';
...
<div class="banner banner-banquetSpace">
    <div class="bg overlay-top overlay-bottom">
        <img src="assets/images/weddings/weddings-banner.jpg" alt="Wedding Venues / Lawn" title="Wedding Venues / Lawn" class="hero-bg-img" />
    </div>
    <div class="banner-container">
        <div class="container-fluid px-3 px-lg-5">
            <div class="banner-title-wrap">
                <h1 class="venue-hero-title">Wedding Venues / Lawn</h1>
                <p class="venue-hero-subtitle">We at Doab Vilas consider each and every event of yours as one of the most important events for us.</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-4 g-xl-5">
            ...
            <div class="col-lg-7 col-xl-8">
                <div class="OffDetailsSe">
                    <div class="content">
                        <h2>Wedding Venues in Meerut</h2>
                        <p>We at Doab Vilas consider each and every event of yours as one of the most important events for us. It's the day you've dreamt about & at Doab Vilas we ensure to make your event / wedding day as magical as you’ve imagined. Doab Vilas, Meerut is an ideal destination for unforgettable celebrations. Our wedding venues offer unparalleled elegance and charm, nestled amidst picturesque surroundings. From 6 luxurious indoor banquets to stunning 2 outdoor gardens and 2 Terrace Pool-side venues, our spaces cater to every style and vision. With top-notch amenities, state-of-the-art facilities, and a dedicated team, we ensure a seamless and memorable experience. Say your vows amidst opulent backdrops and create timeless memories at Doab Vilas. Book your perfect wedding venue today and let us make your special day a truly extraordinary affair. Contact us now for exclusive packages and availability.</p>
                        
                        <p>From the moment you arrive, the sheer beauty and elegance of the DOAB VILAS will take your breath away. Our professionally experienced staff is trained at delivering the sophisticated ambiance you have always imagined for your event / wedding day. Allow our in-house professional wedding planners to plan a perfect event for you.</p>
                        
                        <p>Enjoy our Newly Renovated Luxury Halls, Largest Elevated Waterproof Lounge in Lawn & largest Stage Backdrop in NCR. Best Venue for Residential Weddings with latest Themes & Decors!</p>
                        
                        <p>Doab Vilas takes pride as the only venue for hosting the most important & VIP Events of the Meerut City. Events of Celebrities like Suresh Raina, Bhuvaneshwar Kumar, Honbl. Shri Aditya Yoginath Ji (CM U.P.), Honbl. Shri Amit Shah ji (Minister of Home Affairs), BJP MP/MLA Meet, Zee TV, Aaj Tak, Mercedes, BMW & many more. Doab Vilas stands as a shining gem among the multitude of Wedding Venues in Meerut City. Renowned for its unparalleled beauty, opulence, and impeccable services, it has established itself as one of the finest destinations for hosting extravagant weddings.</p>
            ...
            <div class="col-lg-5 col-xl-4">
                <div class="form-EnqueryInnPAge" id="enquiryFormCard">
                    ...
                    <form action="contact.php" method="POST" onsubmit="event.preventDefault(); alert('Thank you! Your wedding venue enquiry has been received. Our wedding planners will contact you shortly to plan your grand event.'); this.reset();">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="interested" class="form-control form-control-lux" value="Wedding Venues / Lawn" readonly>
                        </div>
                        
                        <div class="form-group mb-4">
                            <label class="form-label-lux">Message *</label>
                            <textarea name="message" rows="4" class="form-control form-control-lux" placeholder="Expected guest count, wedding date, indoor/lawn preference, catering & decor requirements..." required></textarea>
                        </div>
                ...
                <div class="more-dine-card">
                    <a href="weddings.php?event=festival">
                        ...
                        <div class="more-dine-content">
                            ...
                            <p>In addition to world-class accommodation, a wealth of recreation and exceptional dining, Doab Vilas hosts an array of Entertainment and Festival Events.</p>
                        </div>
                    </a>
                </div>
            </div>
