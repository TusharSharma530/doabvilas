<?php 
$pageTitle = 'The Long Island Pub & Bar in Meerut';
...
<div class="banner banner-rooms-suites">
    <div class="bg overlay-top overlay-bottom">
        <img src="assets/images/dining/the-long-Island-pub-bar--DineWine.jpg" alt="The Long Island Pub & Bar" title="The Long Island Pub & Bar" class="hero-bg-img" />
    </div>
    <div class="banner-container">
        <div class="container">
            <div class="content text-center">
                <div class="title">Dine & Wine</div>
                <h1>THE LONG ISLAND</h1>
                <div class="scrdown">
        ...
        <div class="row align-items-center g-4 g-lg-5 mb-5">
            ...
            <div class="col-lg-6">
                <div class="venue-info-content">
                    ...
                    <p>So just come to us and toss a drink to enjoy the evening at our Doab Vilas's Bar.</p>
                </div>
            </div>
        </div>
