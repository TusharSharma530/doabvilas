<?php 
$pageTitle = 'Celebration Party Place for Festivals, Sangeet, Mehndi, Birthday in Meerut India';
    ...
    <div class="banner-container">
        <div class="container-fluid px-3 px-lg-5">
            <div class="banner-title-wrap">
                <h1 class="venue-hero-title">Celebrations</h1>
                <p class="venue-hero-subtitle">We at Doab Vilas specialize in the art of organizing Birthday Parties, Wedding Anniversary, Wedding Reception</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-4 g-xl-5">
            ...
            <div class="col-lg-7 col-xl-8">
                <div class="OffDetailsSe">
                    <div class="content">
                        ...
                        <p>We at Doab Vilas specialize in the art of organizing Birthday Parties, Wedding Anniversary, Wedding Reception, Kitty Parties and Theme Parties for all age groups. We offer numerous services and innovative ideas to enable you to have your event tailor made to fit the occasion and your budget. Doab Vilas is a place specifically designed to celebrate your events under the ambience of nature. To add a sumptuous topping on the platter we have an in-house Multi-Cuisine Restaurant, if there is such a thing as ultimate dining experience. The lounge ambience and designer sitting area at Doab Vilas give you a feel of comfort and warmth.</p>
                        ...
                        <p>From personalized theme decor to customized banquet menus crafted by our expert chefs, we ensure every detail of your special milestone celebration is seamless, elegant, and unforgettable.</p>
            ...
            <div class="col-lg-5 col-xl-4">
                <div class="form-EnqueryInnPAge" id="enquiryFormCard">
                    ...
                    <form action="contact.php" method="POST" onsubmit="event.preventDefault(); alert('Thank you! Your party & celebration enquiry has been received. Our team will contact you shortly.'); this.reset();">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="interested" class="form-control form-control-lux" value="Celebrations" readonly>
                        </div>
                        
                        <div class="form-group mb-4">
                            <label class="form-label-lux">Message *</label>
                            <textarea name="message" rows="4" class="form-control form-control-lux" placeholder="Occasion type (Birthday, Anniversary, Kitty Party), date, number of guests, catering preference..." required></textarea>
                        </div>
