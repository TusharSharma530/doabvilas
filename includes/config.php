...
define('SITE_PHONE', '+91 9761866666');
define('SITE_WHATSAPP', '917078733333');
define('SITE_ADDRESS', 'Meerut Bypass Rd, Sector - 3, Ansal\'s Sushant City, Meerut, Uttar Pradesh 250103, India');

// Social Media Links
define('SOCIAL_FACEBOOK', 'https://www.facebook.com/doabvilas.meerut/');
define('SOCIAL_INSTAGRAM', 'https://www.instagram.com/doabvilasclub/');
define('SOCIAL_YOUTUBE', 'https://www.youtube.com/@doabvilasclub4923');
