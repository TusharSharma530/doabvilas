                ...
                <div class="room-card-item img_hover">
                    <figure style="margin: 0; overflow: hidden; border-radius: 8px;">
                        <a href="room-detail.php?room=premium">
                            <img src="assets/images/rooms/room1.png" alt="Premium Rooms" title="Premium Rooms" class="img-fluid" loading="lazy" style="width: 100%; height: 350px; object-fit: cover; transition: transform 0.5s ease;" />
                        </a>
                    </figure>
