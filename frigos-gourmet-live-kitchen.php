<?php 
$pageTitle = 'Frigo\'s Gourmet - Live Kitchen in Meerut';
...
<div class="banner banner-rooms-suites">
    <div class="bg overlay-top overlay-bottom">
        <img src="assets/images/dining/frigos-gourmet-live-kitchen--DineWine.jpg" alt="Frigo's Gourmet - Live Kitchen" title="Frigo's Gourmet - Live Kitchen" class="hero-bg-img" />
    </div>
    <div class="banner-container">
        <div class="container">
            <div class="content text-center">
                <div class="title">Dine & Wine</div>
                <h1>FRIGO'S GOURMET</h1>
                <div class="scrdown">
        ...
        <div class="row align-items-center g-4 g-lg-5 mb-5">
            ...
            <div class="col-lg-6">
                <div class="venue-info-content">
                    ...
                    <p>Watch our expert chefs prepare your meal right before your eyes, using the freshest ingredients and culinary techniques that will leave you amazed. An unforgettable dining experience awaits you.</p>
                </div>
            </div>
        </div>
                ...
                <div class="dine-card img_hover">
                    <figure>
                        <a href="alfresco-pool-side-bar.php">
                            <img src="assets/images/dining/alfresco-pool-side-bar--DineWine.jpg" alt="Alfresco" class="img-fluid" loading="lazy" />
                        </a>
                    </figure>
                    <div class="dine-card-content">
                        <h5>Alfresco</h5>
                        <p>Pool-side Bar</p>
                        <a href="alfresco-pool-side-bar.php" class="btn-explore">
                            <span>Explore</span>
                            <svg width="22" height="12" viewBox="0 0 22 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 6H20M20 6L15 1M20 6L15 11" stroke="#C9A96A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
