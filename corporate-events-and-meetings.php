<?php 
$pageTitle = 'Place for Corporate Business Events, Seminars, Exhibitions in Meerut, India';
...
<div class="banner banner-banquetSpace">
    <div class="bg overlay-top overlay-bottom">
        <img src="assets/images/weddings/corporate-events-and-meetings-banner.jpg" alt="Corporate Events & Meetings" title="Corporate Events & Meetings" class="hero-bg-img" />
    </div>
    <div class="banner-container">
        <div class="container-fluid px-3 px-lg-5">
            <div class="banner-title-wrap">
                <h1 class="venue-hero-title">Corporate Events & Meetings</h1>
                <p class="venue-hero-subtitle">Whether you are planning a board meeting for 20 or an annual conference for 1,000 persons, you will achieve success at DOAB VILAS.</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-4 g-xl-5">
            ...
            <div class="col-lg-7 col-xl-8">
                <div class="OffDetailsSe">
                    <div class="content">
                        <h2>Corporate Events & Meetings</h2>
                        <p>Whether you are planning a board meeting for 20 or an annual conference for 1,000 persons, you will achieve success at DOAB VILAS. Our skilled planners will work with you to create a function that will motivate your team and get the job done.</p>
                        
                        <p>With over 30,000 square feet of versatile function space and numerous floor plans and set-up options, your event is sure to run smoothly and efficiently. We have enough space that meets your needs. Our dedicated staff will tend to all of the details, ensuring a flawless event from beginning to end. We specialize in organizing events like -</p>
                        ...
                        <h3 class="mt-4 mb-3" style="font-family: 'Playfair Display', serif; font-size: 1.5rem; color: var(--dv-green);">Also Enjoy</h3>
                        <ul class="facilities-bullet-list mb-4">
                            <li>Tele-conferencing</li>
                            <li>Convenient Computer &amp; Telephone Access</li>
                            <li>Complimentary High-Speed Wireless Internet Access</li>
                            <li>Fully Automated Sound System</li>
            ...
            <div class="col-lg-5 col-xl-4">
                <div class="form-EnqueryInnPAge" id="enquiryFormCard">
                    ...
                    <form action="contact.php" method="POST" onsubmit="event.preventDefault(); alert('Thank you! Your corporate event enquiry has been received. Our event team will contact you shortly.'); this.reset();">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="interested" class="form-control form-control-lux" value="Corporate Events & Meetings" readonly>
                        </div>
                        
                        <div class="form-group mb-4">
                            <label class="form-label-lux">Message *</label>
                            <textarea name="message" rows="4" class="form-control form-control-lux" placeholder="Company name, expected attendees, meeting date, projector/AV requirements..." required></textarea>
                        </div>
